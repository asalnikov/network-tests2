...
extern int all_to_all(px_my_time_type **results, int mes_length,int num_repeats);
extern int async_one_to_one(px_my_time_type **results, int mes_length,int num_repeats);
extern void bcast(px_my_time_type **results, int mes_length,int num_repeats);
...
extern int test_noise(px_my_time_type **results,int mes_length, int num_repeats, int num_noise_repeats, int noise_message_length, int num_noise_procs); // FIXME
extern int test_noise_blocking(px_my_time_type **results,int mes_length, int num_repeats, int num_noise_repeats, int noise_message_length, int num_noise_procs); //FIXME
